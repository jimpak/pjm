...
<table>
    ...
    <tr colspan="3" align="center">
        <button type="button" onclick="location.href='/mvcboard/pass.do?mode=edit&idx=${dto.idx}'">수정</button>
        <button type="button" onclick="location.href='/mvcboard/pass.do?mode=delete&idx=${dto.idx}'">삭제</button>
...
<form name="replyform">
    ...
    <table>
        ...
        <tr>
            <td>댓글내용</td>
            <td><textarea name="content" id="content" row="3" cols="30"></textarea></td>
        </tr>
        <tr>
            <td>비밀번호</td>
