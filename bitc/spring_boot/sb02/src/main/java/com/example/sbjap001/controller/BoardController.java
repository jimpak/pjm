...
import com.example.sbjap001.service.FileModeService;
...
public class BoardController {
    ...
    private final FileModeService fileModeService;
    ...
    public void view(Long bno, PageRequestDTO pageRequestDTO,Model model){
        model.addAttribute("fileList",fileModeService.getList(bno));
