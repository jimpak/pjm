...
print(np.abs(ary)) # 절대값.
print(np.sign(ary)) # 부호. (1이면 양수, -1이면 음수)
print(np.sqrt(ary)) # 루트값. (음수의 루트값은 nan으로 출력.) # 경고발생
print(np.logical_not(ary))
print(np.square(ary)) # 제곱값.
...
print("👀"*20)
ary1 = np.random.randint(0, 25, size=(3,3))
print(ary1)
ary2 = np.random.randint(0, 25, size=(3,3))
print(ary2)
